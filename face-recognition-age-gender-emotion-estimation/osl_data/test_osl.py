...
updation_threshold = 0.9
image_size = 160
v = ftk.Verification()
# Pre-load model for Verification
v.load_model("E:/osl_data/models/20180408-102900/20180408-102900.pb")
...
def webcam(path):
    PADDING = 25
    face = cv2.CascadeClassifier('E:/osl_data/models/20180408-102900/haarcascade_frontalface_default.xml')
...
def img_to_encoding(img):
    ...
    aligned = d.align(image, True)[0]
    return v.img_to_encoding(aligned, image_size)


data= img_to_encoding("E:/osl_data/images/Ali.jpg")
...
def who_is_it(image_path, database):
    ...
    if flag==1:
        #image directory
        directory = r'E:/osl_data/images'
        os.chdir(directory)
        name=input('Please Enter your name Beautiful!!:  ')
        cv2.imwrite(name+'.jpg',img0)
        print('Hi '+name)
        
img0=webcam('E:/osl_data/Verify/Test.jpg')
data=database_image()
who_is_it('E:/osl_data/Verify/Test.jpg', data)